...
public:
	...
	SpriteComponent(Texture2D* texture, Actor* actor, const char* name = "SpriteComponent");

	/// <param name="texture">The path of the texture to load</param>
	/// <param name="name">The name of the component instance</param>
	SpriteComponent(const char* path, Actor* actor, const char* name = "SpriteComponent");
